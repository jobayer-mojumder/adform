			...
			<section class="content">
				...
				<div class="table-responsive">
					...
					<TABLE CELLSPACING=0 CELLPADDING=0 BORDER=0  align="center"   class="table table-striped">
						...
						<TR>
							<TD align=center style="color: #336fce"><h1></h1></TD>
						</TR>
						<TR>
							<TD align=center style="color: #336fce"><h1>WELCOME </h1></TD>
						</TR>
						<TR>
							<TD align=center style="color: #336fce"><h2> To </h2></TD>
						</TR>
						<TR>
							<TD align=center style="color: #336fce"><h2>ADMIN PANEL</h2></TD>
						</TR>
						<TR>
							<TD align=center style="color: #336fce"><h1></h1></TD>
						</TR>
