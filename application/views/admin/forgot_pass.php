...
<body class="hold-transition login-page">
	<div class="login-box">
		...
		<form action="<?=site_url('admin/forgot_pass')?>" method="post"  id="register" name="register" onSubmit="return validateForm();">
			...
			<div class="row">
				...
				<!-- /.col -->
				<div class="col-xs-4">
					<button type="submit" name="change" value="submit"  class="btn btn-success btn-block btn-flat">Send</button>
				</div>
				<!-- /.col -->        
			</div>
