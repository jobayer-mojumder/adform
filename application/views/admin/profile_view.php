									...
									<div class="col-sm-12">
										<?php
											if ($this->session->userdata('image_thumb')) {
												$image = base_url().'assets/admin/'.$this->session->userdata('image_thumb');
											} else {
										...
										<h3 class="profile-username text-center"><?=$result->fullname?></h3>

										<ul class="list-group list-group-unbordered">
											<li class="list-group-item">
												<b>Email</b> <a class="pull-right"><?=$result->email?></a>
											</li>
										</ul>
									</div>

									<div class="col-sm-4 pull-right">
										<a href="<?=site_url('admin/update_profile')?>" class="btn btn-primary btn-block"><b>Update Profile</b></a>
									</div>
								</div>
							</div>
							<!-- /.box-body -->
