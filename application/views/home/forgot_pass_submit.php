...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo" style="background:#FFFFFF; margin-bottom:0px; padding-top:20px;">
			...
			<br />
			<h2 class="text-center" style="background:#FBFBFB; color:#336fce; padding-top:0px; margin-top:0px;"> ADMIN LOGIN</h2>
		</div>
		<!-- /.login-logo -->
		...
		<form action="<?=site_url('login/change_password/'.$code)?>" method="post"  id="register" name="register" onSubmit="return validateForm();">
			...
			<div class="form-group has-feedback">
				<input type="password" name="re_password" value=""  class="form-control" placeholder="Re-enter new password"/>
				<span class="glyphicon glyphicon-envelope form-control-feedback"></span>
			</div>
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="text text-right" >
					...
					<p><a href="<?=base_url('login')?>">Back To Login Window</a></p>
				</div>
			</div>
		</div>
	</div>
