                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box box-info">
                            ...
                            <?php } ?>
                            <form class="form-horizontal" method="post" action="<?=base_url('home/update_profile')?>" enctype="multipart/form-data">
                                <div class="box-body">

                                    <div class="form-group">
                                        <label for="fullname" class="col-sm-2 control-label">Full Name</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="fullname" name="fullname" placeholder="Full name Here" required value="<?=$result->full_name?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="col-sm-7" style="display: none; margin-right: 10px;" name="old_image" value="<?=$result->user_image?>" readonly>
